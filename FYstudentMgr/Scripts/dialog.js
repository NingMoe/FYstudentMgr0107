...
; (function ($, window, undefined) {
    ...
    artDialog.fn = artDialog.prototype = {
        ...
        button: function () {
            ...
            $('.aui_icon').css('padding-bottom', '0');
            $('.aui_main').css('padding-bottom', '0');
...
; (function ($, window, artDialog, undefined) {
     ...
     * @param	{Number}	成功1，失败0
     */
    artDialog.tips = function (content, time, mark) {
        if (mark == 1) {
            return _proxyDialog({
                id: 'Tips',
                zIndex: _zIndex(),
...
artDialog.notice = function (options) {
    ...
    var config = {
        ...
        init: function (here) {
            ...
            aConfig = api.config;
            wrap = api.DOM.wrap;
            top = parseInt(wrap[0].style.top) - 70;
