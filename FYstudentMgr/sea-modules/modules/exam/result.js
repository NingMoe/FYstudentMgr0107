define(function (require, exports, module) {
    ...
    $("#timu li").click(function () {
        ...
        //}
        $("#divLoading").show();
        $.post("/Exam/getResultData", { "qusid": idData, "examType": examtype }, function (result) {
            if (result !=null) {
                var strHtml = "";
    ...
    $("#btnMoreDiscuss").click(function () {
        $.post("/Exam/getReply", { "qusid": idData, "page": page }, function (listDiscuss) {
            ...
            for (var i = 0; i < listDiscuss.length; i++) {
                ...
                strHtml += '      <span class="pull-right muted f12">' + date.countNow(listDiscuss[i].createdAt) + '</span>';
                strHtml += '    </p>';
