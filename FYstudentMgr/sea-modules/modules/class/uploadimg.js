define(function (require, exports, module) {
    ...
    require('upload');
    require('qiniu');
    var courseid = $("#classname").attr("data-courseid");
    var imgname =  $("#classname").attr("data-id");
    ...
    var uploader = Qiniu.uploader({
        ...
        uptoken_url: '/Help/UpTokenimg?filename=' + "classimg/" + imgname,
        ...
        //     }
        // },
        domain: 'http://upimg.xueqitian.com',
        ...
        init: {
            ...
            'Key': function (up, file) {
                var key = "classimg/" + imgname;//+"."+ Qiniu.getFileExtension(file.name);
